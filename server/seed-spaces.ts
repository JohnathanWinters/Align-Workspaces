...
const sampleSpaces = [
  ...
  },
  {
    ...
    colorPalette: JSON.stringify({ colors: [{ hex: "#C4A882", name: "Honey Oak" }, { hex: "#E8DDD0", name: "Cream Stone" }, { hex: "#6B7B6B", name: "Forest Calm" }], feel: "Warm honey tones meet creamy softness and deep forest green to build a cocoon of professional trust. The palette feels like a quiet afternoon in a sunlit study — approachable, steady, and safe enough for vulnerability." }),
    targetProfession: "Therapists & Counselors",
  ...
  },
  {
    ...
    colorPalette: JSON.stringify({ colors: [{ hex: "#2C2C2C", name: "Iron Black" }, { hex: "#C4956A", name: "Burnished Gold" }, { hex: "#E8E0D8", name: "Raw Concrete" }], feel: "Bold iron black sets the tone for serious training, burnished gold injects aspirational fire, and raw concrete keeps it grounded and real. This is a palette built for transformation — it says show up, work hard, and earn your gold." }),
  ...
  },
  {
    ...
    colorPalette: JSON.stringify({ colors: [{ hex: "#F7F3EE", name: "Ivory White" }, { hex: "#4A6741", name: "Tropical Green" }, { hex: "#8B7355", name: "Walnut Wood" }], feel: "Clean ivory opens the mind, tropical green channels the Grove's lush energy through the windows, and rich walnut wood lends permanence to every decision made at the table. A palette that balances fresh thinking with rooted confidence." }),
  ...
  },
  {
    ...
    colorPalette: JSON.stringify({ colors: [{ hex: "#1A1A2E", name: "Midnight Navy" }, { hex: "#C0C0C0", name: "Steel Silver" }, { hex: "#FFFFFF", name: "Pure White" }], feel: "Midnight navy commands authority, steel silver reflects the downtown skyline's ambition, and pure white cuts through complexity with clarity. Together they create a high-altitude boardroom atmosphere where every meeting feels consequential." }),
  ...
  },
  {
    ...
    colorPalette: JSON.stringify({ colors: [{ hex: "#E8C8A0", name: "Raw Clay" }, { hex: "#F5F0E8", name: "Gallery White" }, { hex: "#7B4B3A", name: "Kiln Brick" }], feel: "Earthy clay and warm kiln brick bookend a gallery-white canvas, capturing the full arc of the creative process — from raw material to finished piece. This palette feels like potential in your hands, ready to be shaped into something new." }),
