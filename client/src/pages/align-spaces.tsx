                ...
                {(featuredPros || []).slice(0, 6).map((pro) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      {pro.spaceImageUrl && (
                        <div className="absolute -bottom-6 left-3 w-[160px] h-[110px] rounded-xl ring-[3px] ring-white shadow-lg z-20 overflow-hidden">
                    ...
                    <div className={`p-4 ${pro.spaceImageUrl ? "pt-14" : ""}`}>
