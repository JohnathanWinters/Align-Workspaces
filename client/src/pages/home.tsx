                ...
                <div className="relative">
                  ...
                  <AnimatePresence>
                    {menuOpen && (
                      ...
                      >
                        <button onClick={() => { setLocation("/browse"); setMenuOpen(false); }} className="w-full text-left px-4 py-3 text-sm text-foreground/70 hover:text-foreground hover:bg-stone-50 transition-colors flex items-center gap-3" data-testid="link-spaces-header">
                ...
                {[
                  ...
                  >
                    <span className="text-[#c4956a] font-medium">
                      {s.step === 1 ? "Setting" : s.step === 2 ? "First Impression" : s.step === 3 ? "Client Experience" : "Placement"}:
                    </span>
                    <span>{s.label}</span>
                  </button>
                ))}
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    {currentStep === 1 && (
                      <StepContent
                        title="Setting"
                        subtitle="Choose the environment that represents where clients expect to find you."
                        centerTitle
                      >
                    ...
                    {currentStep === 2 && (
                      <StepContent
                        ...
                        subtitle="What should people understand about you instantly?"
                        centerTitle
                      >
                    ...
                    {currentStep === 3 && (
                      <StepContent
                        ...
                        subtitle="How should clients feel working with you?"
                        centerTitle
                      >
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
