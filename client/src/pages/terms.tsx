    ...
    <div className="min-h-screen bg-[#faf8f5]">
      ...
      <main className="max-w-3xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
        ...
        <div className="prose prose-stone prose-sm max-w-none [&_h2]:font-serif [&_h2]:text-xl [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-[#2a2a2a] [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:uppercase [&_h3]:tracking-wider [&_h3]:text-stone-500 [&_h3]:mt-6 [&_h3]:mb-2 [&_h4]:text-sm [&_h4]:font-semibold [&_h4]:text-[#2a2a2a] [&_h4]:mt-4 [&_h4]:mb-2 [&_p]:text-stone-600 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:text-stone-600 [&_li]:mb-1 [&_ol]:text-stone-600">
          ...
          <p><strong>Align Workspaces is not a legal advisor, arbitrator, or mediator.</strong> We are a facilitator and do not take legal sides in any dispute between Hosts and Guests.</p>
          <p>In the event of a dispute between a Host and Guest, users agree to first attempt resolution directly through Platform messaging. Align Workspaces support may help facilitate communication between the parties, but <strong>any assistance we provide is informal and does not constitute legal advice, mediation, or a binding determination.</strong></p>
          <p>If a dispute cannot be resolved informally, users are encouraged to seek resolution through the <strong>American Arbitration Association (AAA)</strong> at <a href="https://www.adr.org" target="_blank" rel="noopener noreferrer">www.adr.org</a>. Align Workspaces is not responsible for the outcome of any arbitration or legal proceeding between users.</p>
          <p><strong>Align Workspaces is not a party to any dispute between Hosts and Guests and assumes no liability for the actions, omissions, or conduct of any user.</strong></p>
